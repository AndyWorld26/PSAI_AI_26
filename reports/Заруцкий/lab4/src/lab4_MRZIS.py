...
plt.subplot(1, 2, 1)
plt.plot(range(1, len(err_train_fixed) + 1), err_train_fixed, 'b-o',
         label="Train (фиксированный α)", linewidth=2, markersize=6)
plt.plot(range(1, len(err_test_fixed) + 1), err_test_fixed, 'r--s',
         label="Test (фиксированный α)", linewidth=2, markersize=6)
...
plt.subplot(1, 2, 2)
plt.plot(range(1, len(err_train_adapt) + 1), err_train_adapt, 'b-s',
         label="Train (адаптивный α)", linewidth=2, markersize=6)
plt.plot(range(1, len(err_test_adapt) + 1), err_test_adapt, 'r-.^',
         label="Test (адаптивный α)", linewidth=2, markersize=6)
